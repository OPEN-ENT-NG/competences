...
public interface ClassAppreciationDigitalSkillsService extends CrudService {
    ...
    void getClassAppreciation(final String id_class, Handler<Either<String, JsonObject>> handler);

    void getAppreciationsClasses(final List<String> listIdsClass, Handler<Either<String, JsonArray>> handler);
}