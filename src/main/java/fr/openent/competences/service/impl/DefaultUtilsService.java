...
public class DefaultUtilsService implements UtilsService {
    ...
    public JsonObject calculMoyenne(List<NoteDevoir> listeNoteDevoirs, Boolean statistiques, Integer diviseurM, Boolean annual) {
        ...
        double unroundAverage = ((sumNIMCIParD + sumCJDJ) / (sumCI + sumCJDJParM));
        double average =  0.0;
        ...
        JsonObject r = new JsonObject().put(Field.MOYENNE, average)
                .put(Field.UNROUND_AVERAGE, unroundAverage)
                .put(Field.HASNOTE, !listeNoteDevoirs.isEmpty());

        if (sumCoefficient == 0)
            r.put(Field.MOYENNE, Field.NN).put(Field.UNROUND_AVERAGE, Field.NN);
    ...
    @Override
    public void list(String structureId,
        ...
        String query =
                "MATCH " + filter + "(u:User) " +
                        ...
                        "u.login as login, u.firstName as firstName, " +
