...
public class DefaultElementProgramme implements ElementProgramme {
    ...
    public void setElementProgramme(String userId, Long idPeriode, String idMatiere, String idClasse,String texte,
        ...
        StringBuilder query = new StringBuilder()
                .append("INSERT INTO ").append(COMPETENCES_SCHEMA).append(".element_programme ")
    ...
    public void getElementProgramme(Long idPeriode, String idMatiere, String idClasse,
        ...
        query.append("SELECT * ")
                .append("FROM "+ COMPETENCES_SCHEMA +".element_programme ")
                .append("WHERE "+ COMPETENCES_SCHEMA +".element_programme.id_classe = ? ")
                .append("AND "+ COMPETENCES_SCHEMA +".element_programme.id_periode = ? ")
                .append("AND "+ COMPETENCES_SCHEMA +".element_programme.id_matiere = ? ");
    ...
    public void getElementProgrammeClasses(Long idPeriode, String idMatiere, JsonArray idsClasse,
        ...
        query.append("SELECT texte, id_classe ")
                .append("FROM ").append(COMPETENCES_SCHEMA).append(".element_programme ")
                .append("WHERE ").append(COMPETENCES_SCHEMA).append(".element_programme.id_classe IN ").append(Sql.listPrepared(idsClasse.getList()))
                .append("AND ").append(COMPETENCES_SCHEMA).append(".element_programme.id_periode = ? ")
                .append("AND ").append(COMPETENCES_SCHEMA).append(".element_programme.id_matiere = ? ");
    ...
    public void getDomainesEnseignement(String idCycle, Handler<Either<String, JsonArray>> handler){
        ...
        query.append("SELECT * FROM " + COMPETENCES_SCHEMA + ".domaine_enseignement ");
        if(idCycle != null){
    ...
    public void getSousDomainesEnseignement(String idDomaine, Handler<Either<String, JsonArray>> handler){
        ...
        query.append("SELECT * FROM " + COMPETENCES_SCHEMA +".sous_domaine_enseignement ");
        if(idDomaine != null){
    ...
    public void getPropositions(String idStructure, Long idSousDomaine, Handler<Either<String, JsonArray>> handler){
        String query = "SELECT * FROM " + COMPETENCES_SCHEMA + ".proposition" +
    ...
    public void createProposition(String idStructure, String libelle, Long idSousDomaine,
                                  Handler<Either<String, JsonArray>> handler){
        String query = "INSERT INTO " + COMPETENCES_SCHEMA + ".proposition " +
                "(libelle, id_sous_domaine, id_etablissement) SELECT ?, ?, ? " +
                "WHERE NOT EXISTS (SELECT id FROM " + COMPETENCES_SCHEMA + ".proposition " +
    ...
    public void editProposition(Long idProposition, String libelle, Handler<Either<String, JsonArray>> handler){
        String query = "UPDATE " + COMPETENCES_SCHEMA + ".proposition " +
    ...
    public void deleteProposition(Long idProposition, Handler<Either<String, JsonArray>> handler){
        String query = "DELETE FROM " + COMPETENCES_SCHEMA + ".proposition " +
                "WHERE id = ?";
        JsonArray values = new fr.wseduc.webutils.collections.JsonArray();
        values.add(idProposition);
        sql.prepared(query.toString(), values, validResultHandler(handler));
