                            ...
                            if (!"ok".equals(body.getString("status"))) {
                                ...
                                if (structure != null) {
                                    ...
                                    if (structure != null) {
                                        ...
                                        if (name != null) {
                                            structureLibelle.add(new JsonObject().put("name", name));
                                        }
                                        if (address != null) {
                                        ...
                                        if (phone != null) {
                                            structureLibelle.add(new JsonObject().put("phone", phone));
                                        }
                                        if (email != null) {
                                    ...
                                    for (int i = 0; suiviAcquis != null && i < suiviAcquis.size(); i++) {
                                        ...
                                        if (positionnementFinal != null) {
                                            ...
                                            if (positionnement != null) {
                                                Integer pos = Math.round(positionnement.getFloat("moyenne"));
                                                String val = "";
