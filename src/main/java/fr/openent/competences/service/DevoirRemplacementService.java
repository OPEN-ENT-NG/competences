...
@Deprecated
public interface DevoirRemplacementService extends CrudService {
     ...
     * l'utilisateur.
     * @param userId Utilisateur en cours
     * @param structureId Identifiant de la structure
     * @param handler handler portant le résultat de la requête.
     */
    void getClassesIdsDevoir(String userId, String structureId, Handler<Either<String, JsonArray>> handler);
