...
public interface BFCService extends CrudService {
     ...
     */
    void buildBFC(boolean recapEval, String[] idEleves, String idClasse, String idStructure, Long idPeriode,
                  Long idCycle, Boolean isYear, Handler<Either<String, JsonObject>> handler);
