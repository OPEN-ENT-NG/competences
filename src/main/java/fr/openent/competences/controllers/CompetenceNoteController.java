...
public class CompetenceNoteController extends ControllerHelper {
    ...
    public CompetenceNoteController(EventBus eb) {
        this.eb = eb;
        competencesNotesService = new DefaultCompetenceNoteService(Competences.COMPETENCES_SCHEMA, Field.COMPETENCES_NOTES_TABLE);
        syntheseService = new DefaultBfcSyntheseService(Competences.COMPETENCES_SCHEMA, Competences.BFC_SYNTHESE_TABLE, eb);
        competenceNiveauFinalService = new DefaultCompetenceNiveauFinalService(Competences.COMPETENCES_SCHEMA, Field.COMPETENCE_NIVEAU_FINAL);
