...
import { getDISP, getEA, getNN, getTitulairesForRemplacantsCoEnseignant, setNullAverageForStudent } from "../../utils/teacher";
...
export class ReleveNote extends  Model implements IModel {
    ...
    saveMoyenneFinaleEleve(eleve): any {
        return new Promise((resolve, reject) => {
            ...
            let statut = majMoyenneFinale === getNN() || majMoyenneFinale === getEA() || majMoyenneFinale === getDISP() ? majMoyenneFinale : null;
