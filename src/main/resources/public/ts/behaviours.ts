...
Behaviours.register('competences', {
    rights: {
        workflow: {
            ...
            canSaisiAppreciationCPE: "fr.openent.competences.controllers.BilanPeriodiqueController|initWorkflowCreateAppreciationCPEBilanPeriodique",
            ...
            createAvisConseilBilanPeriodique: 'fr.openent.competences.controllers.BilanPeriodiqueController|initWorkflowCreateAvisConseilBilanPeriodique',
