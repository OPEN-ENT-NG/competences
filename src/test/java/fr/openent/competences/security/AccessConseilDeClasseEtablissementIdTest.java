...
public class AccessConseilDeClasseEtablissementIdTest {

    AccessConseilDeClasseEtablissementId access;
    ...
    public void setUp() throws NoSuchFieldException {
        access = new AccessConseilDeClasseEtablissementId();
